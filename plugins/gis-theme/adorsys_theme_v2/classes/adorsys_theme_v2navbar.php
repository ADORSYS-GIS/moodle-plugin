...
namespace theme_adorsys_theme_v2;
...
/**
 * Creates a navbar for adorsys_theme_v2 that allows easy control of the navbar items.
 *
 * @package    theme_adorsys_theme_v2
 * @copyright  2021 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class adorsys_theme_v2navbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_adorsys_theme_v2();
    }

    /**
     * Prepares the navigation nodes for use with adorsys_theme_v2.
     */
    protected function prepare_nodes_for_adorsys_theme_v2(): void {
        global $PAGE;
    ...
    /**
     * Get all the adorsys_theme_v2navbaritem elements.
     *
     * @return adorsys_theme_v2navbaritem[] adorsys_theme_v2 navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this adorsys_theme_v2 navbar
     */
    ...
    /**
     * Remove a adorsys_theme_v2navbaritem from the adorsys_theme_v2 navbar.
     *
     * @param  string|int $itemkey An identifier for the adorsys_theme_v2navbaritem
     * @param  int|null $itemtype An additional type identifier for the adorsys_theme_v2navbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the adorsys_theme_v2navbaritem.
     */
