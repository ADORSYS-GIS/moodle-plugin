...
impl OtelConfig {
    pub fn from_env() -> Result<Self> {
        // Get OTEL_HOST and OTEL_PORT
        let host = env::var("OTEL_HOST").unwrap_or_else(|_| "0.0.0.0".to_string());
        let port = env::var("OTEL_PORT").unwrap_or_else(|_| "8888".to_string());
        ...
        let log_exporter_endpoint = env::var("OTEL_LOGS_EXPORTER_ENDPOINT")
